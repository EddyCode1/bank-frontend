...
// Datos mock para desarrollo cuando el backend no expone listados de usuarios
const MOCK_USERS = [
  {
    id: 'user-001',
  ...
  },
  {
    ...
    rol: 'USER_ROLE',
    cuentas: [{ id: 'account-007', numero: '7777777777', tipo: 'Ahorros', saldo: 4500.75, estado: 'active' }],
  },
  {
    id: 'user-005',
