...
const quickLinksBase = [
  ...
  { id: 5, label: 'Saldos',         path: '/loby/saldos',       icon: '💳', roles: ['USER_ROLE', 'ADMIN_ROLE'] },
  { id: 6, label: 'Horarios',       path: '/loby/schedules',     icon: '🕐', roles: ['USER_ROLE', 'ADMIN_ROLE'] },
  { id: 7, label: 'Transacciones',  path: '/loby/transactions',  icon: '⇄', roles: ['USER_ROLE', 'ADMIN_ROLE'] },
];
